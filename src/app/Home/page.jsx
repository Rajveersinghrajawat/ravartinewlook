...
export default function Home() {
  ...
  return (
    <>
      ...
      {/* New NEW ARRIVALS */}
      <div className='bg-[#f8f7f2] py-[30px] mb-[50px]'>
...
function ProductCard() {
  return (
    <div className="p-[25px] md:p-[65px] mw-[433px] grid lg:grid-cols-3 grid-cols-1 md:grid-cols-2 max-w-[100%] mx-auto gap-[40px]">
